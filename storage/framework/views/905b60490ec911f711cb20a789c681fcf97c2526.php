	...
	<div class="container">
		<div class="row">
			<div class="col-lg-4 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
				...
				<h2 data-aos="fade-up" data-aos-delay="400">A e-commerce product to get your business online</h2>
		...
		<div class="container">
			...
			<div class="row content">
				<div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
					<p>
						Femiza is a e-commerce product powered by Magento that helps to get you business online. A responsive and clean UI helps users to navigate through the website easily and search their required product.
					</p>
					<ul>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\old_services\resources\views/project-femiza.blade.php ENDPATH**/ ?>