...
<body style="">
	...
	<div class="container">
		<section class="invoice">
			<div class="row">
				<div style="font-size: 16px; padding: 30px 10px">We appreciate you reaching out to us. We have received you request and our representatives will get in touch with you soon. For more information visit <a href="https://services.sellzmart.com">Sellzmart Services</a>.</div>
			</div>
			<div class="row">
				<div class="col-xs-12">
					<h2 class="page-header">
						<small class="pull-right">Date: <?php echo e(date("j-m-Y")); ?></small>
					</h2>
				</div>
				<!-- /.col -->
			</div>
...
</html><?php /**PATH C:\xampp\htdocs\sellzmartservices\resources\views/emails/contact.blade.php ENDPATH**/ ?>