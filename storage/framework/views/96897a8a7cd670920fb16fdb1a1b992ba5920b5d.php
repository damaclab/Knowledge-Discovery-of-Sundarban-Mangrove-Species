				...
				<div class="col-lg-6 col-md-12" data-aos="fade-up" data-aos-delay="100">
					<form action="<?php echo e(url('pricing')); ?>" method="post" role="form" class="php-email-form">
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="form-group">
									<input type="text" class="form-control" name="phone" id="phone_no" placeholder="Your Phone No." data-rule="minlen:10" data-msg="Please enter a valid phone no." onkeypress="return isNumber(event)" required=""/>
									<div class="validate"></div>
								</div>
							</div>
						</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sellzmartservices\resources\views/pricing.blade.php ENDPATH**/ ?>