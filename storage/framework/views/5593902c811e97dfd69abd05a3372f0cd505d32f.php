        ...
        <div class="col-lg-6 col-md-12" data-aos="fade-up" data-aos-delay="300">
        	<form action="<?php echo e(url('contact-us')); ?>" method="post" role="form" class="php-email-form">
        		...
        		<div class="form-group">
        			<input type="text" name="name" class="form-control" id="name" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter a valid name" required=""/>
        		...
        		<div class="form-group">
        			<input type="text" class="form-control" name="subject" id="subject" placeholder="Subject" data-rule="minlen:4" data-msg="Please enter a valid subject" required=""/>
        			<div class="validate"></div>
        		</div>
        		<div class="form-group">
        		...
        		<div class="mb-3">
        			...
        			<div class="sent-message">Thank you for getting in touch with us! Our representatives will get back to you shortly.</div>
        		</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sellzmartservices\resources\views/contact.blade.php ENDPATH**/ ?>