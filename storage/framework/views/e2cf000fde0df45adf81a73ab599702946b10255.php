  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-4 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
        <h1 data-aos="fade-up">Project Page</h1>
        <h2 data-aos="fade-up" data-aos-delay="400">A one line description about the product or project.</h2>
    ...
    <div class="container">
      ...
      <div class="row content">
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
          ...
          <ul>
            <li><i class="ri-check-double-line"></i> Key point about the project 1</li>
            <li><i class="ri-check-double-line"></i> Key point about the project 2</li>
            <li><i class="ri-check-double-line"></i> Key point about the project 3</li>
          </ul>
        </div>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\services\resources\views/projects.blade.php ENDPATH**/ ?>