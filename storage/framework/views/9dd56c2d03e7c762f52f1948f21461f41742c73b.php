...
<?php $__env->startSection('title', 'Datasets'); ?>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
				<img src="<?php echo e(asset('img/datasets-hero.jpg')); ?>" class="img-fluid animated" alt="">
			</div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="row">
					...
					<div class="row no-gutters slider-text align-items-center justify-content-center" style="margin-top: 3em; margin-bottom: 2em;">
						<div class="col-12 ftco-animate text-center" id="example" style="background-color: #fdfdfd">
							<div class="uploadOuter">            
								<form method="post" id="fileDropzone" class="dropzone" action="<?php echo e(url('upload')); ?>" id="file-upload-form" enctype="multipart/form-data">
									<?php echo csrf_field(); ?>
				...
				<div class="col-md-5 col-sm-12" data-aos="fade-up" data-aos-delay="300">
					...
					<form action="<?php echo e(url('download-dataset')); ?>" method="post">
						<?php echo csrf_field(); ?>
						<?php echo method_field('POST'); ?>
						<div class="form-group">
							<select class="form-control" id="dataset_type" style="color: #6c757d;" required="" onchange="fetchDatasets()">
								<option value="">-- Select Dataset Type --</option>
								<?php $__currentLoopData = $dataset_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dataset_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option value="<?php echo e($dataset_type->dataset_type); ?>"><?php echo e($dataset_type->dataset_type); ?></option>
...
<script type="text/javascript">
	...
	function fetchDatasets() {
		...
		if (dataset_type != null) {
			...
			var url = "<?php echo e(url('/fetch-datasets-by-type')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project\resources\views/datasets.blade.php ENDPATH**/ ?>