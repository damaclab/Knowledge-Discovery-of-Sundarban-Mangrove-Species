			...
			<nav class="nav-menu d-none d-lg-block">
				<ul>
					...
					<li class="drop-down"><a href="">Projects</a>
						<ul>
							<li><a href="<?php echo e(url('project/sellzmart')); ?>">Sellzmart</a></li>
							<li><a href="<?php echo e(url('project/femiza')); ?>">Femiza Ecommerce</a></li>
							<li><a href="<?php echo e(url('project/ridein')); ?>">RideIn</a></li>
...
</html><?php /**PATH C:\xampp\htdocs\old_services\resources\views/layouts/header.blade.php ENDPATH**/ ?>