...
<?php $__env->startSection('title', 'Technical Documentation'); ?>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
				<img src="<?php echo e(asset('img/documentation-hero.webp')); ?>" class="img-fluid animated" alt="">
			</div>
		</div>
	</div>
			...
			<div class="row content">
				...
				<div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="150">
					...
					<div class="hero-img" data-aos="fade-left" data-aos-delay="200">
						<img src="<?php echo e(asset('img/indian-mangrove.png')); ?>" class="img-fluid animated" alt="">
					</div>
				</div>
			</div>
		</div>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project\resources\views/documentation.blade.php ENDPATH**/ ?>