	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-7 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
				<img src="{{ asset('img/pricing.jpg') }}" class="img-fluid animated" alt="">
			</div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="row">
					...
					<div class="row">
						<div class="col-lg-12 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="100">
							<div class="contact-about">
								<h3><a href="{{ url('home') }}"><img src="{{ asset('img/logo2.png') }}" alt="" class="img-fluid"></a></h3>
				...
				<div class="col-lg-6 col-md-12" data-aos="fade-up" data-aos-delay="100">
					<form action="{{ url('pricing') }}" method="post" role="form" class="php-email-form">
						@csrf
						...
						<div class="row">
							<div class="col-lg-6">
								<select id="country_code" class="form-control" name="country_code" style="color: #6c757d;">
							...
							<div class="col-lg-6">
								<div class="form-group">
									<input type="text" class="form-control" name="phone" id="phone_no" placeholder="Your Phone No." data-rule="minlen:7" data-msg="Please enter a valid phone no." onkeypress="return isNumber(event)" maxlength="15" required=""/>
									<div class="validate"></div>
								</div>
							</div>
						</div>
						<div class="form-group">
							<select class="form-control" name="subject" id="subject" data-rule="minlen:6" data-msg="Please choose a subject" style="color: #6c757d;" required="">
						...
						<div class="mb-3">
							...
							<div class="sent-message">We have saved your requirements. Our support team will get back to you shortly.</div>
						</div>
			...
			<div class="row">
				...
				<div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
					<div class="icon-box" data-aos="fade-up" data-aos-delay="300">
						...
						<p class="description">We have no hidden charges. All charges will be informed up-front.</p>
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
					<div class="icon-box" data-aos="fade-up" data-aos-delay="400">
						...
						<h4 class="title"><a href="">Pay As You Get</a></h4>
						<p class="description">Pay your charges in 4 equal instalments incrementally with the progress of software development.</p>
					</div>
				</div>
